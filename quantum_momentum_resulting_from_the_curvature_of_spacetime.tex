...
\label{sec:model}
In curved space (as in general relativity), the coordinates are no longer Euclidean, and therefore position itself becomes dependent on the curvature of spacetime. In quantum mechanics, position and momentum are not independent, as observed from the uncertainty principle. 
\begin{equation}
...
Online references:
\begin{itemize}
  \item Repository: \url{https://github.com/scikyrollesashraf/Momentum-resulting-from-the-curvature-of-spacetime}
  \item Citable archived release (Zenodo DOI):  \href{doi.org}{10.5281/zenodo.18203331}
